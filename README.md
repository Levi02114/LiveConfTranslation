...
새 세션은 언어별 입력 페이지 + 언어별 출력 페이지 + 통합 조회 + 참가자 안내를 만듭니다.
입력 페이지 하나에서 타자, 검토 후 보내는 수동 STT, 즉시 보내는 자동 음성 입력을 선택할
수 있습니다. `/capture` 주소는 이전 버전에서 만든 AI 전사 세션과의 호환을 위해 유지됩니다.
...
[v0.9.9 릴리스 페이지](https://github.com/Levi02114/LiveConfTranslation/releases/tag/v0.9.9)에서 다음 중
하나를 내려받습니다.
...
- 전사 모델은 현재 `gpt-transcribe`를 사용합니다.
