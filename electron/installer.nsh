...
!macro customInit
  ...
  nsExec::ExecToStack '"$SYSDIR\WindowsPowerShell\v1.0\powershell.exe" -NoProfile -NonInteractive -Command "$$os=Get-CimInstance Win32_OperatingSystem; $$r=[int64](Get-CimInstance Win32_ComputerSystem).TotalPhysicalMemory; $$f=[int64]$$os.FreePhysicalMemory*1024; $$v=[int64]((Get-ItemProperty ''HKLM:\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\*'' -Name ''HardwareInformation.qwMemorySize'' -ErrorAction SilentlyContinue | Measure-Object ''HardwareInformation.qwMemorySize'' -Maximum).Maximum); if ($$v -le 0) { $$v=[int64]((Get-CimInstance Win32_VideoController | Measure-Object AdapterRAM -Maximum).Maximum) }; if (($$v -ge 21474836480 -and $$r -ge 34359738368) -or ($$r -ge 42949672960 -and $$f -ge 25769803776)) { exit 3 }; if (($$v -ge 10737418240 -and $$r -ge 17179869184) -or ($$r -ge 21474836480 -and $$f -ge 10737418240)) { exit 2 }; if ($$r -ge 17179869184 -and $$f -ge 6442450944) { exit 1 }; exit 0"'
  Pop $0
  Pop $1
  ${If} $0 == 3
